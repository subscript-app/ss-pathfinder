...
/// FROM `ss_pathfinder_ui::PADDING`
pub const PADDING: i32 = 12; // FROM `ss_pathfinder_ui::PADDING`
/// FROM `ss_pathfinder_ui::PADDING`
pub const LINE_HEIGHT: i32 = 42; // FROM `ss_pathfinder_ui::PADDING`
/// FROM `ss_pathfinder_ui::PADDING`
pub const FONT_ASCENT: i32 = 28; // FROM `ss_pathfinder_ui::PADDING`
    ...
    D: Device,
{
    ...
    pub ui_presenter: PhantomData<D>,
